...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date("Dec 5, 2021 00:00:00").getTime(),
...
new TypeIt("#teks1", {
  strings: [
    ...
    " ",
    "Saya Dera Okta Padilah pada hari ini Minggu, 5 Desember 2021 dengan sepenuh hati mengucapkan",
    " ",
    "<b>Selamat Ulang Tahun Yang ke - 17</b>",
    " ",
    "Kepada yang terhormat ibu negaranya aku, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya",
    ,
    " ",
    "Wassalamualakaikum Wr. Wb",
    " ",
    "- Dera Okta .P, Mas ganteng :)",
  ],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [
    ...
    "Happy Birthday ya..",
    " ",
    "Ciie udah 17 tahun, padahal baru aja beberapa hari kemarin umur kita sama hehe, semoga di umur yang sekarang kamu bisa jadi pribadi yang lebih baik lagi, lebih rajin, lebih sholehah, dan lebih berbakti.",
